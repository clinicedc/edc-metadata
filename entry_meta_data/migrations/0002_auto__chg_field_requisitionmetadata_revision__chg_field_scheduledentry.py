...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RequisitionMetaData.revision'
        db.alter_column(u'entry_meta_data_requisitionmetadata', 'revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'ScheduledEntryMetaData.revision'
        db.alter_column(u'entry_meta_data_scheduledentrymetadata', 'revision', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

    def backwards(self, orm):

        # Changing field 'RequisitionMetaData.revision'
        db.alter_column(u'entry_meta_data_requisitionmetadata', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'ScheduledEntryMetaData.revision'
        db.alter_column(u'entry_meta_data_scheduledentrymetadata', 'revision', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

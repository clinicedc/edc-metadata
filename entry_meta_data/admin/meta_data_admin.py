...
class ScheduledEntryMetaDataAdmin(BaseModelAdmin):
    ...
    list_display = ('registered_subject', 'edc_entry', 'entry_status', 'fill_datetime', 'due_datetime', 'close_datetime', 'created', 'hostname_created')
    ...
    def formfield_for_foreignkey(self, db_field, request, **kwargs):
        ...
        if db_field.name == "edc_entry":
            kwargs["queryset"] = Entry.objects.filter(pk=request.GET.get('edc_entry'))

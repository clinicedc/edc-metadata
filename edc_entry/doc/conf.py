...
htmlhelp_basename = 'bhp_entrydoc'
...
latex_documents = [
  ('index', 'bhp_entry.tex', u'bhp\\_entry Documentation',
...
man_pages = [
    ('index', 'bhp_entry', u'bhp_entry Documentation',
...
texinfo_documents = [
  ('index', 'bhp_entry', u'bhp_entry Documentation',
   u'erik van widenfelt', 'bhp_entry', 'One line description of project.',
   'Miscellaneous'),
]
